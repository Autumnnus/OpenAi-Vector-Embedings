...
const response = await openai.chat.completions.create({
  ...
  messages: [
    ...
    {
      role: "user",
      content: "I'm a skarter. I'm lloking for skateboarding shoes",
    },
  ],
  functions: [
    {
      ...
      description:
        "Takes a short description and returns a recommended product",
      parameters: {
        type: "object",
        properties: {
          description: {
            type: "string",
            description:
              "A short description of the product the user is looking for, ideally a copy paste from the user's mesage",
          },
        },
      },
    },
